...
import { generateRegularPolygonAdvanced, type RegularPolygonInput } from '@/lib/geometry';
...
export async function POST(req: NextRequest) {
  ...
  try {
    const result = generateRegularPolygonAdvanced(body.input as RegularPolygonInput);
