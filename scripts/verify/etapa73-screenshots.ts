/**
 * ETAPA 73 FAZA E — screenshots pentru bucla vizuală OBLIGATORIE.
 ...
 * Ieșire: docs/design-review/etapa73/<ecran>-<viewport>.png
 *
 *   npx tsx --env-file=.env.local scripts/verify/etapa73-screenshots.ts
 */
...
const OUT = join(process.cwd(), 'docs', 'design-review', 'etapa73');
...
async function main() {
  ...
  // o conversație reală cu mesaje pentru ecranul de chat
